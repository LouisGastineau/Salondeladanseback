...
Route::middleware(['auth:sanctum', 'throttle:api'])->group(function () {
    ...
    Route::prefix('admin')->middleware('role:admin')->group(function () {
        ...
        Route::get('editions', [AdminController::class, 'editions']);
        Route::post('editions', [AdminController::class, 'storeEdition']);
        Route::get('editions/{id}', [AdminController::class, 'edition'])->whereNumber('id');
        ...
        Route::get('creneaux', [AdminController::class, 'adminCreneaux']);
        Route::post('creneaux', [AdminController::class, 'storeCreneau']);
        Route::patch('creneaux/{id}', [AdminController::class, 'updateCreneau'])->whereNumber('id');
        Route::delete('creneaux/{id}', [AdminController::class, 'deleteCreneau'])->whereNumber('id');
